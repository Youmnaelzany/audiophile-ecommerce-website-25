...
const MyCategory = ({ name, link, categoryImg }: { name: string, link: string, categoryImg: StaticImageData }) => {
  return (
    <div className="w-[20.4375rem] h-[10.3125rem] bg-light-grey flex flex-col justify-end items-center gap-6 rounded-lg pb-[1.38rem] lg:pb-[1.88rem] sm:w-[13.9375rem] lg:w-[21.875rem] lg:h-[12.75rem]">
