...
export default function BestGear() {
  return (
    <div className="flex flex-col gap-y-8 sm:gap-y-12 lg:gap-x-32 items-center justify-center lg:justify-between lg:flex-row-reverse px-6 sm:pl-[2.44rem] sm:pr-10 lg:px-[10.31rem] py-[7.5rem] lg:py-40">
      <picture>
      ...
      <div className="space-y-8 flex flex-col items-center justify-center text-center lg:text-left lg:items-start lg:justify-start w-[21.4375rem] sm:w-[34.8125rem] lg:w-[30.8125rem]">
